...
$jscomp.polyfill("WeakMap",function(a){function b(){if(!a||!Object.seal)return!1;try{var b=Object.seal({}),c=Object.seal({}),d=new a([[b,2],[c,3]]);if(2!=d.get(b)||3!=d.get(c))return!1;d["delete"](b);d.set(c,4);return!d.has(b)&&4==d.get(c)}catch(p){return!1}}function c(a){$jscomp.owns(a,e)||$jscomp.defineProperty(a,e,{value:{}})}function d(a){var b=Object[a];b&&(Object[a]=function(a){c(a);return b(a)})}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;
...
shakaDemo.Main.prototype.init=function(){var a=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function c(){var d,e,f,g,h,l;return $jscomp.generator.createGenerator(c,function(c){switch(c.nextAddress){case 1:return a.initCommon_(),d=a,c.yield(shaka.Player.probeSupport(),2);case 2:d.support_=c.yieldResult;a.video_=document.getElementById("video");a.video_.poster=shakaDemo.Main.mainPoster_;a.container_=document.getElementsByClassName("video-container")[0];if(!navigator.serviceWorker){c.jumpTo(3);
break}console.debug("Registering service worker.");c.setCatchFinallyBlocks(4);return c.yield(navigator.serviceWorker.register("service_worker.js"),6);case 6:e=c.yieldResult;console.debug("Service worker registered!",e.scope);c.leaveTryBlock(3);break;case 4:f=c.enterCatchBlock(),console.error("Service worker registration failed!",f);case 3:return a.noInput_="noinput"in a.getParams_(),a.setupPlayer_(),a.readHash_(),window.addEventListener("hashchange",function(){return a.hashChanged_()}),c.yield(a.setupStorage_(),
7);case 7:a.setupBugButton_();if(a.noInput_){for(var k=$jscomp.makeIterator(document.getElementsByClassName("should-hide-in-no-input-mode")),m=k.next();!m.done;m=k.next())g=m.value,a.hideNode_(g);k=$jscomp.makeIterator(document.getElementsByClassName("should-show-in-no-input-mode"));for(m=k.next();!m.done;m=k.next())h=m.value,a.showNode_(h);a.container_.classList.add("no-input-sized");document.getElementById("video-bar").classList.add("no-input-sized")}a.dispatchEventWithName_("shaka-main-loaded");
return c.yield(Promise.resolve(),8);case 8:componentHandler.upgradeDom(),l=a.getLastAssetFromHash_(),a.fullyLoaded_=!0,a.remakeHash(),l&&!a.selectedAsset&&a.loadAsset(l),c.jumpToEnd()}})})};
...
shakaDemo.Main.prototype.drmConfiguration_=function(a,b){var c=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function e(){var f,g,h,l,k,p,m;return $jscomp.generator.createGenerator(e,function(e){switch(e.nextAddress){case 1:f=b?b.getNetworkingEngine():c.player_.getNetworkingEngine();goog.asserts.assert(f,"There should be a net engine.");a.applyFilters(f);g=a.getConfiguration();b?b.configure(g):(c.player_.resetConfiguration(),c.player_.configure(c.desiredConfig_),c.player_.configure(g));
h=b?b.getConfiguration():c.player_.getConfiguration();if(!a.certificateUri){for(var q=$jscomp.makeIterator(a.licenseServers.keys()),n=q.next();!n.done;n=q.next())l=n.value,h.drm.advanced[l]&&delete h.drm.advanced[l].serverCertificate;e.jumpTo(2);break}return e.yield(c.requestCertificate_(a.certificateUri,f),3);case 3:for(k=e.yieldResult,p=new Uint8Array(k),q=$jscomp.makeIterator(a.licenseServers.keys()),n=q.next();!n.done;n=q.next())m=n.value,h.drm.advanced[m]=h.drm.advanced[m]||{},h.drm.advanced[m].serverCertificate=
p;case 2:b?b.configure(h):c.player_.configure("drm.advanced",h.drm.advanced),c.remakeHash(),e.jumpToEnd()}})})};shakaDemo.Main.prototype.showPlayer_=function(){var a=document.getElementById("video-bar");this.showNode_(a);this.closeError_();this.video_.poster=shakaDemo.Main.mainPoster_;a.scrollIntoView({behavior:"smooth",block:"start"})};
